  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.colorScheme.surface, // FIX biar ada card gelap
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: AppColors.primary.withValues(alpha: 0.15), borderRadius: BorderRadius.circular(6)), // FIX
                    child: Text(cat, style: GoogleFonts.poppins(fontSize: 9, color: AppColors.primary))
                  ),
