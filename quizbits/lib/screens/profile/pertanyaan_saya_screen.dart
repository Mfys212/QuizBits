    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Pertanyaan Saya'),
          leading: IconButton(icon: const Icon(Icons.arrow_back), onPressed: () => Navigator.pop(context)),
          bottom: TabBar(
            labelStyle: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 12),
            tabs: const [Tab(text: 'Semua'), Tab(text: 'Publik'), Tab(text: 'Draft')]
          )
        ),
        body: TabBarView(
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: (isPublik? AppColors.success : AppColors.warning).withValues(alpha: 0.15), // FIX tadinya hardcode 0xFFDCFCE7
                      borderRadius: BorderRadius.circular(6)
                    ),
                    child: Text(status, style: GoogleFonts.poppins(fontSize: 9, color: isPublik? AppColors.success : AppColors.warning)),
                  ),
                  const SizedBox(height: 6),
                  Row(children: [
                    const Icon(Icons.visibility, size: 10, color: AppColors.textMuted),
