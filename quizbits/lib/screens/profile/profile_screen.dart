...
import '../settings/bantuan_faq_screen.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text('Profil', style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w600)),
                    IconButton(
                      icon: const Icon(Icons.settings_outlined, color: Colors.white),
                      onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const PengaturanScreen())),
                    ),
                  ],
                ),
          ...
          Divider(height: 1, color: theme.dividerColor.withValues(alpha: 0.2)), // FIX
          ...
          _Menu(icon: Icons.help_outline, title: 'Bantuan & FAQ', onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const BantuanFaqScreen()))),
...
class _Menu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      onTap: onTap,
      leading: Icon(icon, color: isLogout? AppColors.danger : theme.iconTheme.color, size: 20), // FIX tadinya textDark
      title: Text(title, style: GoogleFonts.poppins(fontSize: 13, color: isLogout? AppColors.danger : theme.textTheme.bodyMedium?.color)), // FIX
      trailing: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          if (count!= null) Text(count!, style: GoogleFonts.poppins(fontSize: 12, color: AppColors.textMuted)),
